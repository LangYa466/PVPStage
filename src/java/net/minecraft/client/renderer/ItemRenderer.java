...
import cn.SuperSkidder.PVPStage.Modules.render.OldBlock;
            ...
            if (this.itemToRender != null)
            {
                ...
                else if (abstractclientplayer.getItemInUseCount() > 0)
                {
                    ...
                    switch (enumaction)
                    {
                        ...
                        case BLOCK:
                            if(PVPStage.moduleManager.getModByClass(OldBlock.class).getState()){
                                transformFirstPersonItem(f / 2.0F, f1);
                                float var15 = MathHelper.sin(MathHelper.sqrt_float(f) * 3.1415927F);
